...
needs_types = [
    dict(directive="req-sys", title="System Requirement", prefix="SYS_REQ_", color="#BFD8D2", style="node"),
    dict(directive="sys-drs", title="System Design Requirement", prefix="SYS_DRS_", color="#BFD8D2", style="node"),
    dict(directive="fmea", title="Failure mode", prefix="FMEA_", color="#DF744A", style="node"),
    dict(directive="test", title="Test Case", prefix="TC_SYS_", color="#DCB239", style="node"),
]
needs_statuses = [
...
needs_tags = [
    ...
    dict(name="legal", description="tag for legal requirements"),
    dict(name="gen1.0", description="requirements relevant for gen1.0 development")
]
needs_extra_options = [
